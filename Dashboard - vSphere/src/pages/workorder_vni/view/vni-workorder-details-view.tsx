...
import { VNIWorkOrderDetails } from '../vni-workorder-details';

// ----------------------------------------------------------------------

function VNIWorkOrderDetailsView() {
  const { id } = useParams();
  ...
  return (
    <DashboardContent>
      ...
      <VNIWorkOrderDetails vniWorkOrder={vniWorkOrder} />
    </DashboardContent>
  );
}

export default VNIWorkOrderDetailsView; 